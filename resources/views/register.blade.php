...
@section('content')
<div class="container app-register">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        ...
                                        @foreach (range(1, 31) as $m)
                                            <option value="{{$m}}" {{ old('day_of_birth') == $m ? 'selected' : ''}}>{{$m}}</option>
                                        @endforeach;
                                        </select>
                                    ...
                                    <div class="col-5">
                                        ...
                                        @foreach (range(1, 12) as $m)
                                            <option value="{{$m}}" {{ old('month_of_birth') == $m ? 'selected' : ''}}>{{date('F', mktime(0, 0, 0, $m, 1))}}</option>
                                        @endforeach;
                                        </select>
                                     ...
                                     <div class="col-4">
                                        ...
                                        @foreach (range(1989, date("Y")) as $m)
                                            <option value="{{$m}}"  {{ old('year_of_birth') == $m ? 'selected' : ''}}>{{$m}}</option>
                                        @endforeach;
                                        </select>
